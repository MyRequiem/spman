...
##### Build and install:
1. `~# wget https://github.com/MyRequiem/spman/archive/1.5.1/spman-1.5.1.tar.gz
2. `~# tar -xvzf spman-1.5.1.tar.gz`
3. `~# cd spman-1.5.1/slackbuild`
4. `~# ./spman.SlackBuild`
5. `~# upgradepkg --install-new --reinstall /tmp/spman-1.5.1-*.t?z`
