...
class MajorTests(object):
    ...
    def start(self):
        ...
        start checks
        """
        self.check_exist_dirs()
        self.check_exists_files()

    def check_exist_dirs(self):
        """
        check exists dirs
        """
    ...
    def check_exists_files(self):
        ...
        for repo in self.repos:
            ...
            pkg_exist = path.isfile('{0}{1}/{2}'.format(
                self.spman_conf['REPOS_PATH'], repo, pkg_file))
            log_exist = path.isfile('{0}{1}/{2}'.format(
                self.spman_conf['LOGS_PATH'], repo, log_file))
