...
class ShowInfoRepos(object):
    ...
    def start(self):
        ...
        for repo in sorted(repos):
            ...
            print('============= ' + repo + ' =============')
            print('URL: {0}'.format(self.meta.get_repo_dict()[repo]))
            print('Last updated: {0}'.format(rdata['lupd']))
            print('Number of packages: {0}'.format(rdata['numpkgs']))
            if repo != 'sbo':
                print(('Total compressed '
                       'packages: {0}').format(rdata['comp']))
                print(('Total uncompressed '
                       'packages: {0}').format(rdata['uncomp']))

            if repo == 'slack':
                print('php')
                print(rdata['pkgs']['php'])
            elif repo == 'multilib':
                print('gcc')
