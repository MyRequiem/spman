...
# checkhealth file is part of spman
...
class CheckHealth(object):
    ...
    def __init__(self):
        ...
        self.count_files = 0
        self.list_pkg_installed = listdir(self.meta.pkgs_installed_path)
        ...
        for pkgname in self.list_pkg_installed:
            if (self.pkgs.get_parts_pkg_name(pkgname)[0] not in
                ...
                with open('{0}{1}'.format(self.meta.pkgs_installed_path,
                    ...
                    for line in pkgfile:
                        if count_lines > 19:
                            self.check_exists_file(line.strip(), pkgname)
                        count_lines += 1

        self.show_rezult()

    def check_exists_file(self, line, pkgname):
        """
        check exists file
        """
    ...
    def show_rezult(self):
        ...
        print(('\n{0}: {1}{2}'.format(str1,
                ...
                # 'Broken packages: {1}\n'
                # 'Total files: {2}\n'
                # 'Broken files: {3}').format(len(self.list_pkg_installed),
